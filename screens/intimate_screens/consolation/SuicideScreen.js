...
class SuicideScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
  ...
  static navigationOptions = {
    headerTitle:<View style={{textAlign:'center'}}>
                    <Text style={{fontSize: 30, fontFamily: 'cloud-bold', color: '#fff'}}>สัญญาณเตือนการฆ่าตัวตาย</Text>
                </View>,
  ...
  render() {
    return (
        ...
        <Card>
          <Text style={styles.TxtTitle}> สัญญาณเตือนการฆ่าตัวตาย </Text>
