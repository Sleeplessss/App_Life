...
export class StayalertScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
      ...
      static navigationOptions = {
        headerTitle:<View style={{textAlign:'center'}}>
                        <Text style={{fontSize: 30, fontFamily: 'cloud-bold', color: '#fff'}}>การเฝ้าระวัง/ดูแล</Text>
                    </View>,
  ...
  render() {
    return (
        ...
        <Card>
          <Text style={styles.TxtTitle}> การเฝ้าระวัง/ดูแล </Text>
...
export default StayalertScreen
