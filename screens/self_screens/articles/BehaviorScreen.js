...
class BehaviorScreen extends Component {
  static navigationOptions = {
    headerTitle:<View style={{textAlign:'center'}}>
                        <Text style={{fontSize: 30, fontFamily: 'cloud-bold', color: '#fff'}}>พฤติกรรมที่ชัดเจนของ...</Text>
                    </View>,
  ...
  render() {
    return (
      ...
      <Card>
        <Text style={styles.TxtTitle}> พฤติกรรมที่ชัดเจนของ{'\n'}การลงมือทำร้ายตนเอง </Text>
