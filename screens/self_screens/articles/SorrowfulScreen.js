...
class SorrowfulScreen extends Component {
  static navigationOptions = {
    headerTitle:<View style={{textAlign:'center'}}>
                        <Text style={{fontSize: 30, fontFamily: 'cloud-bold', color: '#fff'}}>ลักษณะความทุกข์ใจที่พบ</Text>
                    </View>,
  ...
  render() {
    return (
      ...
      <Card>
        <Text style={styles.TxtTitle}> ลักษณะความทุกข์ใจที่พบ </Text>
